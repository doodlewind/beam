// ============================================================================
// Public type surface — mirrors reference-api.d.ts EXACTLY (minus the Beam class,
// which lives in the device module). Imported by every other module.
// ============================================================================
...
// 'sampler' filters color textures; 'samplerNonFilter' is required to sample
// non-filterable textures (e.g. a depth32float target as plain color);
// 'samplerCompare' is a comparison sampler for shadow maps.
